...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
        "inline-flex h-11 items-center justify-center rounded-xl border border-border/70 bg-white/70 p-1 text-muted-foreground shadow-sm backdrop-blur",
      className
    )}
    {...props}
  />
